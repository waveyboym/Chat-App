...
const PersonalDetails = (props) => {
  ...
  const {userDB, setLoadingTrue} = useAuth();
  ...
  const [confirmDelete, set_ConfirmDelete] = useState(false);
  ...
  function uploadImg(e){setform({ ... form, [e.target.name] : e.target.files[0]});}
  ...
  function submitChanges(){
    ...
    changePersonalDetails(obj).then((message) => {
            ...
            <div className="pd-form-object">
                ...
                { showpassword ?
                  ...
                  onClick={() => set_showpassword(false)} className="password-control">
                    { props.Theme === 'light'? <img src={eyeopened_LM} alt="show-password"/>
                      : <img src={eyeopened_DM} alt="show-password"/>}
                  </motion.div>
                  :
                  <motion.div whileHover={{ opacity: 0.8 }} whileTap={{scale: 0.97}}
                  onClick={() => set_showpassword(true)} className="password-control">
                    { props.Theme === 'light'? <img src={eyeclosed_LM} alt="hide-password"/>
