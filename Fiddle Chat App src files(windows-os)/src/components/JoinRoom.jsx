...
const roomNameState = {roomName: ''}

const JoinRoom = (props) => {
  const [form, setform] = useState(roomID);
  const [roomName, setRoomName] = useState(roomNameState);
  ...
  function handleRoomName(e){setRoomName({ ... roomName, [e.target.name] : e.target.value});}

  function changeSelectedMsg(uid){
