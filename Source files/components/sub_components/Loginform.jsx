...
const Loginform = (props) => {
    ...
    function loginProviders(providername){
        setLoadingTrue();
        if(providername === "google")signInWithRedirect(auth, googleprovider);
        else if(providername === "facebook")signInWithRedirect(auth, facebookprovider);
        else if(providername === "twitter")signInWithRedirect(auth, twitterprovider);
        else if(providername === "github")signInWithRedirect(auth, githubprovider);
    }
